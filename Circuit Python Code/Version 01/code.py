...
def update_display(disp, ina219_info):
    ...
    display_text(disp, "    V-In:  {:6.3f}   V".format(ina219_info["VIN_IN"]), 0, 0, 1)
    display_text(disp, "   V-Out:  {:6.3f}   V".format(ina219_info["VIN_OUT"]), 0, 1, 1)
    display_text(disp, " V-Shunt:  {:8.5f} V".format(ina219_info["ShuntV"]), 0, 2, 1)
    display_text(disp, " I-Shunt: {:7.3f}   A".format(ina219_info["ShuntC"]), 0, 3, 1)
    display_text(disp, "Powr-Cal:  {:8.5f} W".format(ina219_info["PowerCal"]), 0, 4, 1)
    display_text(disp, "   Power:  {:6.3f}   W".format(ina219_info["PowerRegister"]), 0, 5, 1)
